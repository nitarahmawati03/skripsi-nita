...
class Perhitungan extends CI_Controller
{
	...
	{
		$this->form_validation->set_rules('check_list[]', 'Anda belum memilih gejala, pilihan gejala masih kosong', 'required');
		$this->form_validation->set_message('required', 'Anda belum memilih gejala, pilihan gejala masih kosong');
