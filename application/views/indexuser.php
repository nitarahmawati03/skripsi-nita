...
<body>
                             ...
                             <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent" style="margin-left: 300px">
                              <!-- <nav id="nav-menu-container"> -->
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo site_url('Welcome/menulogin')?>" class="nav-link">Login</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
    ...
    <section class="about_part section_padding" id="bantuan">
     ...
     <!-- <section class="client_review" id="bantuan">
        <div class="container">
            <div class="row align-items-center justify-content-between">
    ...
    <!-- about part start-->
   <!--  <section class="about_part section_padding" id="login">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6">
                    <div class="about_img">
